...
Esta documentación es para {{site.data.keyword.knowledgestudiofull}} en {{site.data.keyword.cloud}}. Para ver la documentación para la versión anterior de {{site.data.keyword.knowledgestudioshort}} en {{site.data.keyword.IBM_notm}} Marketplace, [pulse este enlace ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://{DomainName}/docs/services/knowledge-studio/annotate-documents.html){: new_window}.
{: tip}
...
1. Seleccione la página **Modelo de aprendizaje automático** > **Tareas de anotación**.
...
Una vez que se haya creado la tarea, puede volver a la página **Modelo de aprendizaje automático** > **Tareas de anotación** para ver el progreso de cada anotador humano. Además, puede realizar las tareas siguientes:
...
En el separador **Configuración** de la navegación principal, puede especificar la información siguiente:
...
1. Inicie sesión como administrador de {{site.data.keyword.knowledgestudioshort}}, y seleccione su espacio de trabajo.
2. En la navegación de la izquierda, seleccione **Configuración** > **Configuración de la anotación de documentos**.
3. Seleccione el separador **Tipos de entidades** o **Tipos de relaciones**.
4. Seleccione el tipo de entidad o el tipo de relación que desee modificar y luego pulse **Editar atajos de teclado y colores**. Para cada tipo, puede definir:

    - Un atajo de teclado, lo que significa que un usuario puede especificar `<key>` para aplicar la etiqueta de tipo a texto resaltado. Por ejemplo, si define `o` como el atajo de teclado para `ORGANIZATION`, un usuario podrá seleccionar texto y pulsar la tecla `o` para aplicar el tipo de entidad `ORGANIZATION` al texto resaltado. Si asigna una letra en mayúscula, el usuario debe pulsar `Shift+<key>`.
...
5. También puede cambiar el color para resaltar de la selección predeterminada. El color para resaltar es el color del borde que se muestra alrededor del texto una vez que los anotadores humanos lo seleccionan. El color predeterminado es un azul claro, pero puede cambiarlo en el separador **Resalte de selección** para facilitar la identificación de los límites del texto que se ha seleccionado.
...
1. Inicie sesión como administrador de {{site.data.keyword.knowledgestudioshort}}, y seleccione su espacio de trabajo.
1. Seleccione el separador **Configuración** > **Configuración de IAA**.
2. Especifique un valor entre 0 y 1, como `.5` u `.8`, y luego pulse **Guardar**.
...
1. Inicie sesión como administrador de {{site.data.keyword.knowledgestudioshort}}, y seleccione su espacio de trabajo.
1. Seleccione el separador **Configuración** > **Directrices de anotación**.
1. Especifique el URL donde se alojan las directrices.
...
<table summary="Esta tabla describe los tipos de entidad.">
  <caption>Tabla 1. Tipos de entidades</caption>
  <tr>
    <th style="vertical-align:bottom; text-align:left" width="24%" id="d1735e810">Tipo de entidad</th>
    <th style="vertical-align:bottom; text-align:left" width="38%" id="d1735e812">Directrices</th>
    <th style="vertical-align:bottom; text-align:left" width="38%" id="d1735e814">Ejemplos</th>
  </tr>
  <tr>
    ...
    <td headers="d1735e812">
      <p>Una consecuencia de un accidente. Se aplica tanto a los humanos (por ejemplo, muerte) como a los automóviles (por ejemplo, abollado). Puede incluir "towed" y "air bag deployment" como indicadores de gravedad del daño, y "transported
to hospital"
(pero no funeraria) como indicadores de gravedad del daño. Puede incluir negación.</p>
    </td>
...
relacionado con sufferedFrom a este ACCIDENT_OUTCOME), como indicaciones de gravedad.</p>
    </td>
  </tr>
  <tr>
    <td headers="d1735e810">
    ...
    <td headers="d1735e812 ">
      <p>Condiciones meteorológicas o de la carretera; un aspecto de la escena que podría afectar a la probabilidad de accidente
y que podría cambiar de un día para otro, pero que no se trata del coche ni del conductor.</p>
      <p>Puede ser un error de conductor o mecánico, y debe aparecer como problemático. Debería excluir STRUCTURE.</p>
    </td>
    <td headers="d1735e814">
      <p>"dry", "rainy", "construction", "heavy traffic", "daylight", pero no "grassy" ni
"intoxicated".</p><p>"flat tire", "overcorrected" (como en dirección), "asleep", "intoxicated", "[failed to
...
"departing the road", que es un INCIDENT.</p>
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>Una mención real de una colisión, o un movimiento de un coche que es inequívocamente inapropiado y posiblemente
destructivo, como salirse de la carretera, o algún otro incidente perjudicial, como un incendio en un coche. </p>
      <p>No
...
"came to final rest", incluso aunque estén estrechamente asociados.</p>
      <p>Excluya STRUCTURE de la extensión;
...
incidente, no un ACCIDENT_OUTCOME (no anotar la rotación de vehículos).</p>
      <p>"came to final rest" en
...
the roadway" (no meramente salir de un carril, lo que podría ser una causa).</p>
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>La empresa que hace el vehículo.</p>
    </td>
    <td headers="d1735e814">
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>El tipo de coche específico, hecho por un fabricante específico. Excluya cualesquiera indicadores de línea de términos/recorte adicionales
...
SE").</p>
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>El año del modelo que forma parte del nombre del coche.</p>
    </td>
    <td headers="d1735e814">
      <p>'99, 2001</p>
    </td>
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>Una parte de un vehículo, ya sea dentro o fuera del mismo, independientemente de si está específicamente
...
parte específica.</p><p>Puede ser plural. Puede incluir la especificación de posición en el vehículo, como por ejemplo
...
barcos volcados, tanques, etc., excepto semirremolques, que tienen un año/modelo/fabricante distinto.</p>
    ...
    <td headers="d1735e814">
      <p>Sección transversal, plano frontal, neumático, volante, airbag, etc.</p>
    </td>
  </tr>
  <tr>
    <td headers="d1735e810">
    ...
    <td headers="d1735e812">
      <p>Cualquier persona descrita en una escena de accidente en un informe (podría ser un conductor o un
pasajero/ocupante de un vehículo, peatón o testigo).</p>
      <p>No anote adjetivos, para no anotar "a [69-year-old] drove", sino "a 69-year-old [male] drove". Puede ser plural, p. ej. "LR and RF [occupants]". Excluye las personas que llegan después del incidente.</p>
      <p>A falta de un tipo de entidad
...
para moverse los convierte más en PERSON que una STRUCTURE.</p>
      <p>Nota: "passenger airbag" es una
PART_OF_CAR; no implica que una persona esté presente.</p>
    </td>
    <td headers="d1735e814">
      <p>Conductor, ocupante, paciente, niño</p>
    </td>
  </tr>
  <tr>
    <td headers="d1735e810">
    ...
    <td headers="d1735e812">
      <p>Una estructura que está en, cerca de, o forma parte de una carretera. Incluya adjetivos de carretera específicos que sean relevantes
para la configuración de un accidente; omita otros adjetivos.</p>
    </td>
    <td headers="d1735e814">
...
[exit ramp], [pole], [tree], steep descending [embankment]</p>
  ...
  <tr>
    ...
    <td headers="d1735e812">
      <p>Cualquier referencia a vehículos que no sea MODEL, MANUFACTURER ni MODEL_YEAR. Puede ser plural, en
cuyo caso la correferencia es muy poco probable y no tiene relación de parte de grupo.</p>
      <p>Tenga en cuenta solo los vehículos
...
<table summary="Esta tabla describe los tipos de relación.">
  <caption>Tabla 2. Tipos de relaciones</caption>
  <tr>
    <th style="vertical-align:bottom; text-align:left" width="33%" id="d1735e923">
      Posibles tipos de entidades para la primera mención
    </th>
    ...
    <th style="vertical-align:bottom; text-align:left" width="48%" id="d1735e927">
      Posibles tipos de entidad para la segunda mención
    </th>
  </tr>
  <tr>
...
MODEL_YEAR [<b>1</b>]
  ...
  <tr>
    ...
    <td headers="d1735e927">
      CONDITION, ACCIDENT_CAUSE <strong>(recordatorio: requiere pruebas textuales de la causalidad)</strong>
    </td>
  </tr>
  <tr>
    <td headers="d1735e923">
...
MODEL_YEAR [<b>1</b>] chocado o involucrado en el accidente.</p>
...
1.  MODEL y MANUFACTURER solo pueden ser el primer argumento de hasProperty, solo cuando aparecen como nombres (referencias a un vehículo). MODEL puede tener la relación hasProperty con MANUFACTURER y MODEL_YEAR, como en "the '99 Honda Accord drove". MANUFACTURER solo puede tener la relación hasProperty con MODEL_YEAR, como en "the '99 Honda drove".
