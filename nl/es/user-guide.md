...
1. Crear una tarea que le asigna para anotar los documentos del conjunto.
...
- Determine cómo manejará el equipo las listas y los plurales en el texto en ejecución. Por ejemplo, el sistema de tipos KLUE tiene los tipos de entidades PERSON y PEOPLE que distinguen el singular del plural. Puede elegir anotar la lista *Barack, Michelle, Malia, and Sasha Obama*, de una de las formas siguientes:
    ...
    - Anotar cada elemento de la lista como una mención de entidad singular (*Barack*, *Michelle*, *Malia*, and *Sasha Obama* son cada una una mención de PERSON)
    ...
    Ningún enfoque es necesariamente mejor que el otro; pero asegúrese de que su equipo elija uno de ellos, y lo aplique de forma coherente a cualquier lista que se dé en los documentos.
...
- Si comete un error, puede pulsar `Ctrl+Z` para deshacer la acción anterior. Para rehacer la acción después de deshacerla, pulse `Ctrl+Y`. Puede deshacer las 10 acciones anteriores que haya realizado mientras edita el documento actual; se perderán cuando cierre el documento. Las acciones deben deshacerse en orden inverso, y usted debe conmutar a la modalidad en la que estaba al realizar la acción para deshacerla. No puede deshacer ni rehacer acciones de la herramienta de concordancia.
...
1. Abra un espacio de trabajo y luego abra la tarea en la que desee trabajar. Se mostrarán los conjuntos de anotaciones que tiene asignados.
1. Pulse un documento para abrirlo. De forma predeterminada, el documento abre **Anotación de documentos** > **Mención**, que es la modalidad que se utiliza para anotar menciones de entidades.
1. Para anotar una mención de entidad:
...
1. Abra un espacio de trabajo y luego abra la tarea en la que desee trabajar. Se mostrarán los conjuntos de anotaciones que tiene asignados.
1. Pulse un documento para abrirlo. De forma predeterminada, el documento abre **Anotación de documentos** > **Menciones**.
...
1. Seleccione los documentos a los que desee aplicar el tipo de entidad seleccionado. Puede crear las anotaciones en todos los documentos que se han asignado para anotar, todos los documentos que ha comenzado a anotar, o todos los documentos que aún no se han empezado a anotar. Pulse **Vista previa** para ver las anotaciones que se añadirán.
1. Si desea ver las anotaciones en mayor contexto, pulse los iconos para previsualizar el contenido del documento o abrir el documento en una ventana nueva.
...
1. Para crear una cadena de correferencia:
    ...
    1. Para resaltar todas las menciones de una cadena para revisarlas en su contexto, pase el cursor por encima de la cadena en el panel lateral.
...
1. Para eliminar una cadena de correferencia que acaba de añadir, pulse `Ctrl+Z` para deshacer la acción. Para eliminar una cadena de correferencias posteriormente, desde el panel lateral Cadenas de correferencia, pulse la **X** junto a la cadena que desee eliminar. Para eliminar una única mención de la cadena, pulse el ID de correferencia para abrir una ventana que muestra una lista de las menciones de la cadena y, a continuación, pulse la **X** junto a la mención que desee eliminar.
1. Pulse **Guardar** en cualquier momento para guardar el trabajo.
...
1. Pulse **Anotación de documentos** > **Relaciones**.
