...
1. Selecione **Gerenciamento de modelo** > **Desempenho**. As estatísticas de desempenho sobre a versão atual, rotulada versão 1.0, são exibidas.
1. Para tomar uma captura instantânea da versão atual, na guia **Gerenciamento de modelo** > **Versões** > **Aprendizado de máquina**, clique em **Tomar captura instantânea**. Os recursos na versão 1.0 são congelados e uma nova versão, rotulada como 1.1, se torna a versão atual. Para cada nova versão que você cria, o número da versão secundária é incrementado, por exemplo, 1.0 torna-se 1.1 e depois torna-se 1.2.
...
1. Se os resultados de desempenho são piores e você deseja reverter para uma versão anterior antes de testar mais adiante:
    ...
    1. Abra a guia **Ativos e ferramentas** > **Pré-anotadores** > **Dicionários** e faça download de quaisquer dicionários que você deseja reutilizar no modelo restaurado.
    1. Retorne para a guia **Gerenciamento de modelo** > **Versões** > **Aprendizado de máquina** e clique em **Promover** para a versão que você deseja restaurar. A versão que você promove se torna a atual e o número da versão muda para 2.0. Quando você promove uma versão, o número da versão principal é incrementado e o número da versão secundária se torna 0, por exemplo, 1.1 torna-se 2.0.
    1. Abra a guia **Dicionários** e faça upload dos dicionários transferidos por download.
    1. Se o teste da nova versão requerer mudanças na verdade absoluta, abra a guia **Ativos e ferramentas** > **Documentos** > **Tarefas** e crie uma nova tarefa de anotação.
...
1. Na guia **Ativos e ferramentas** > **Documentos** > **Tarefas**, abra cada tarefa que você deseja atualizar e clique em **Aplicar atualizações do sistema de tipos**.
