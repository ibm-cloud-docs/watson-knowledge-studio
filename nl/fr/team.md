...
1. Localisez le nom de l'utilisateur dont vous souhaitez changer le rôle, puis cliquez sur le lien **Editer**.
    ...
    - **Admin**
      ...
      Les utilisateurs ayant ce rôle peuvent effectuer les tâches suivantes :
        ...
        - Gérer un abonnement, par exemple ajouter des fonctionnalités, de la mémoire (espace de stockage) et d'autres utilisateurs
        - Donner à des utilisateurs l'accès à un abonnement à partir de la page Détails du service
        - Créer et gérer tous les espaces de travail de leur abonnement
        - Nommer des personnes aux rôles de chef de projet ou d'annotateur humain pour tous les espaces de travail

    - **ProjectManager**

      Les utilisateurs ayant ce rôle peuvent effectuer les tâches suivantes :

      - Gérer les espaces de travail auxquels ils sont ajoutés
      - Affecter des annotateurs humains à un espace de travail

      Les utilisateurs ayant ce rôle ne peuvent pas effectuer les tâches suivantes :

      - Créer des espaces de travail
      - Gérer les accès et les rôles des utilisateurs à partir de la page Détails du service
