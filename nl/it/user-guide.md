...
- Determina come il team gestirà gli elenchi e i plurali nel testo in esecuzione. Ad esempio, il sistema tipo KLUE ha i tipi di entità PERSON e PEOPLE che distinguono il singolare dal plurale. Puoi scegliere di annotare l'elenco *Barack, Michelle, Malia, and Sasha Obama*, in uno dei seguenti modi:
    ...
    Nessuno dei due approcci è necessariamente migliore dell'altro; ma assicurati che il tuo team scelga uno dei due e lo applichi coerentemente a tutti gli elenchi che si verificano nei documenti.
...
- Se commetti un errore, puoi premere `Ctrl+Z` per annullare l'azione precedente. Per ripetere l'azione dopo averla annullata, premi `Ctrl+Y`. Puoi annullare le precedenti 10 azioni che hai eseguito mentre modificavi il documento corrente; andranno perse non appena chiudi il documento. Le azioni devono essere annullate in ordine inverso e devi passare alla modalità in cui eri quando hai seguito l'azione per annullarla. Non puoi annullare e ripetere le azioni dello strumento di concordanza.
...
1. Apri uno spazio di lavoro e poi l'attività su cui vuoi lavorare. Vengono visualizzate le serie di annotazioni che ti sono state assegnate.
1. Fai clic su un documento per aprirlo. Per impostazione predefinita, il documento apre **Document Annotation** > **Mention**, che è la modalità che utilizzi per annotare le citazioni dell'entità.
1. Per annotare una citazione dell'entità:
...
1. Apri uno spazio di lavoro e poi l'attività su cui vuoi lavorare. Vengono visualizzate le serie di annotazioni che ti sono state assegnate.
1. Fai clic su un documento per aprirlo. Per impostazione predefinita, il documento apre **Document Annotation** > **Mentions**.
...
1. Seleziona i documenti a cui vuoi applicare il tipo di entità selezionato. Puoi creare le annotazioni in tutti i documenti a cui sei stato assegnato per l'annotazione, tutti i documenti che hai iniziato ad annotare o tutti i documenti che non hai ancora iniziato ad annotare. Fai clic su **Preview** per visualizzare le annotazioni che saranno aggiunte.
1. Se vuoi controllare le annotazioni in un contesto più grande, fai clic sulle icone per visualizzare un'anteprima del contenuto del documento o aprirlo in una nuova finestra.
...
1. Fai clic su **Document Annotation** > **Coreferences**.
1. Per creare una catena di coreferenza:
    ...
    1. Per evidenziare tutte le citazioni in una catena per controllarle nel contesto, passa con il mouse sulla catena nel pannello laterale.
...
1. Per rimuovere una catena di coreferenza che hai appena aggiunto, premi `Ctrl+Z` per annullare l'azione.  Per rimuovere una catena di coreferenza in un secondo momento, dal pannello laterale Coreference Chains, fai clic su **X** accanto alla catena che vuoi rimuovere. Per rimuovere una sola citazione dalla catena, fai clic sull'ID di coreferenza per aprire una finestra che visualizza l'elenco delle citazioni nella catena e poi fai clic su **X** accanto alla citazione che vuoi rimuovere.
1. Fai clic su **Save** in qualsiasi momento per salvare il tuo lavoro.
...
1. Fai clic su **Document Annotation** > **Relations**.
