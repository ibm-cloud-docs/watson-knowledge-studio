...
1. Seleziona **Model Management** > **Performance**. Vengono visualizzate le statistiche della versione corrente, etichettata versione 1.0.
1. Per prendere un'istantanea della versione corrente, nella scheda **Model Management** > **Versions** > **Machine Learning**, fai clic su **Take Snapshot**. Le risorse nella versione 1.0 vengono bloccate e la nuova versione, etichettata 1.1, diventa la corrente. Per ogni nuova versione che crei, viene incrementato il numero minore di versione, ad esempio, 1.0 diventa 1.1 che poi diventa 1.2.
...
1. Se i risultati delle prestazioni sono peggiori e vuoi ripristinare una versione precedente prima di ulteriori test:
    ...
    1. Apri la scheda **Assets & Tools** > **Pre-annotators** > **Dictionaries** e scarica tutti i dizionari che vuoi riutilizzare nel modello ripristinato.
    1. Ritorna alla scheda **Model Management** > **Versions** > **Machine Learning** e fai clic su **Promote** della versione che vuoi ripristinare. La versione che promuovi diventa la versione corrente e il numero di versione viene modificato con 2.0. Quando promuovi una versione, viene incrementato il numero di versione maggiore e il minore diventa 0, ad esempio, 1.1 diventa 2.0.
    1. Apri la scheda **Dictionaries** e carica i dizionari che hai scaricato.
    1. Se il test della nuova versione richiede modifiche al ground truth, apri la scheda **Assets & Tools** > **Documents** > **Tasks** e crea una nuova attività di annotazione.
...
1. Nella scheda **Assets & Tools** > **Documents** > **Tasks**, apri ogni attività che vuoi aggiornare e fai clic su **Apply Type System Updates**.
